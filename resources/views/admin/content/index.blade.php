                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-3 items-center">
                        ...
                        <div>
                         ...
                         href="{{route('admin.advertise.categories.create')}}">افزودن مطلب جدید</a>
                        </div>
                    ...
                    <table class="table-fixed text-right w-full px-2">
                        <thead class="">
                            <tr class=" bg-gray-800 text-white rounded font-normal text-sm">
                                ...
                                <th class="py-4 px-2 font-thin w-28">عنوان مطلب</th>
                                <th class="py-4 px-2 font-thin w-28">دسته بندی</th>
                                <th class="py-4 px-2 font-thin w-20"> تگ ها</th>
                                <th class="py-4 px-2 font-thin w-20">  تعداد بازدید</th>
