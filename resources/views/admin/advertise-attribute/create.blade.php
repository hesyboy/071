    ...
    <div class=" my-3  ">
        ...
        <div class="flex items-center">
            ...
            <div class="w-full">
                ...
                <div class="mt-3">
                    <form action="{{route('admin.advertise.attributes.store')}}" method="post">
                        @csrf
                        <div class="w-full flex flex-col gap-5">
                                    ...
                                    <div class="w-full md:w-3/12">
                                        ...
                                        <select name="filter_id" class="px-2 py-2 my-2 rounded text-sm w-full bg-gray-50 border-gray-400">
                                            ...
                                            @foreach ($filters as $item)
                                                <option value={{$item->id}} @if(old('filter_id')==$item->id) selected @endif>{{$item->title}} </option>
                            ...
                            <div>
                                ...
                                <div class="flex justify-end gap-3 items-center mt-2">
                                    <div class="mt-2">
                                        <button type="submit" class=" text-sm text-center py-2 px-4 bg-emerald-600 hover:bg-emerald-700 text-gray-100 rounded  ">افزودن مقدار جدید </button>
                                    </div>
                                    <div class="mt-2">
