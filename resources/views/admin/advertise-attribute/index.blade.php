            ...
            <div class="mb-3 bg-white shadow rounded p-3">
                <div class="flex justify-between items-center">
                    <div class="text-xl font-bold py-3">
                        <span> مقادیر فیلترهای آگهی</span>
                        <span class="text-sm">( مجموع : {{count($attributes)}} )</span>
                    </div>
                    <div class="flex gap-3 items-center">

                        <div>
                            <a class="text-sm text-center py-2 px-4 bg-emerald-600 text-white rounded hover:bg-emerald-700"
                         href="{{route('admin.advertise.attributes.create')}}">افزودن مقدار جدید</a>
                        </div>
                    ...
                    <table class="table-fixed text-right w-full px-2">
                        <thead class="">
                            <tr class=" bg-gray-800 text-white rounded font-normal text-sm">
                                ...
                                <th class="py-4 px-2 font-thin w-28">مقدار</th>
                                <th class="py-4 px-2 font-thin w-28">عنوان فیلتر</th>
                                <th class="py-4 px-2 font-thin w-20"> دسته بندی فیلتر</th>
                            ...
                            <tr class="border-b hover:bg-gray-100">
                                ...
                                <td class="py-3 px-2">
                                    <span class=" text-gray-500 text-xs">
                                        {{$item->getFilter->title}}
                                    </span>
                                </td>

                                <td class="py-3 px-2">
                                    <span class=" text-gray-500 text-xs">
                                        {{$item->getFilter->getCategory->title}}
                                    </span>
                                </td>
                                ...
                                <td class="py-3 px-2">
                                    <div class="flex items-center">
                                        ...
                                        <div class="rounded-lg py-1 px-2 text-black text-sm">
                                            <a href="{{route('admin.advertise.attributes.edit',$item)}}" class=" text-xs text-center py-1 px-2 bg-orange-500 text-white rounded hover:bg-orange-600 ">مشاهده و تغییرات</a>
                                        </div>
                                                     ...
                                                     @click.away="popup=false">
                                                        <div>
                                                            ...
                                                            <div class="flex gap-5 p-3 justify-between">
                                                                <form action="{{route('admin.advertise.attributes.delete',$item)}}" method="post">
                                                                    @csrf
                                                                    @method('delete')
