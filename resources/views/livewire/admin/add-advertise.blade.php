...
@if ($filters!=null && count($filters)>0 && $category_id!=null)
    <div class="flex flex-col gap-3 bg-white p-5 shadow rounded">
            ...
            @foreach ($filters as $item)
                @if($item->filter_type==0)
                    <div class="w-full md:w-3/12">
                        ...
                        <input name="" class="px-2 py-2 my-2 rounded text-sm w-full bg-gray-50 border-gray-400"
                        type="text">
                    </div>

                @elseif($item->filter_type==1)
                    <div class="w-full md:w-3/12">
                        <div class="text-sm">
                            <span>{{$item->title}}</span>
                        </div>
                        <select  class="px-2 py-2 my-2 rounded text-sm w-full bg-gray-50 border-gray-400">
                            <option value="">انتخاب کنید </option>
                ...
                @elseif($item->filter_type==2)
                    <div class="w-full h-20 md:w-3/12 flex items-center gap-1 py-2">
                        <input class="form-check-input appearance-none h-6 w-6 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox" value="">
...
{{-- Price --}}
                    ...
                    <div class="w-full md:w-6/12">
                        ...
                        <div class="flex gap-3 items-center">
                                ...
                                @else
                                    ...
                                    <div class=" border-2 border-dashed rounded-lg p-1 relative">
                                        <img id="preview" class="rounded-lg w-40 h-24"  src="{{$item->temporaryUrl()}}">
                                    </div>
                                    @endforeach
            ...
            <div>
                ...
                <div class="flex justify-end gap-3 items-center mt-2">
                    <div class="mt-2">
                        <button type="submit" class=" text-sm text-center py-2 px-4 bg-emerald-600 hover:bg-emerald-700 text-gray-100 rounded  ">افزودن آگهی جدید </button>
                    </div>
                    <div class="mt-2">
